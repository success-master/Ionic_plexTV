...
@IonicPage()
@Component({
  selector: 'page-lancamentos-filmes',
  templateUrl: 'lancamentos-filmes.html',
})
export class LancamentosFilmesPage {
...
console.log(this.lista);
  ...
  chamarlista(newpage: boolean = false){
    ...
    this.AbreCarregando();
    this.ApiProvider.LancamentosFilmes(this.page).subscribe(data=>{
